 ...
 */public interface AdminUserService extends IService<User> {  
     ...
     * @return  
     */
    BaseResponse<Boolean> deleteUser(UserDeleteRequest deleteRequest);
     ...
     * @return
     */  
    BaseResponse<Page<UserVO>> fuzzyPageQuery(UserQueryRequest userQueryRequest);
     ...
     * @return  
     */  
    BaseResponse<UserVO> searchUser(UserSearchRequest searchRequest);
     ...
     * @return  
     */  
    BaseResponse<Boolean> addUser(UserAddRequest addRequest);
